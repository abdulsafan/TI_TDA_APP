 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "javacodegeeks.com", ownerName = "javacodegeeks.com", packagePath="android.bluetoothtest"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBz_1iKKueUBAEQwfyqBZsN-VCaGoTIMqI";
